...
#if ('Documents/git/AirSim/PythonClient' not in sys.path):
#    sys.path.insert(0, 'Documents/git/AirSim/PythonClient')
from AirSimClient import CarClient, CarControls, ImageRequest, AirSimImageType
